...
(function () {
  ...
  function init() {
    ...
    btn.addEventListener('click', function () {
      ...
      fetch('/__save', { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({ edits: edits, textEdits: textEdits }) })
...
// (e.g. index.html?edit) — a normal visitor never sees them.
const EDIT_ENABLED = /(?:[?&#])edit\b/.test(location.search + location.hash);
...
function App() {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(window.Header, {
    ...
    onNav: onNav
  }), EDIT_ENABLED && /*#__PURE__*/React.createElement(window.SybarisDesignSystem_c8b90c.ImageEditToggle, null), EDIT_ENABLED && /*#__PURE__*/React.createElement(window.SybarisDesignSystem_c8b90c.ImageLibrary, {
